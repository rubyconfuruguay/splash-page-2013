...
(function ($) {
	...
	$.fn.countdown = function( method /*,options*/ ) {  
		...
		var defaults = {
				date: (new Date()),
				updateTime: 1000,
				htmlTemplate: "<li><span class=\"cd-time\">days</span> <strong>%{d}</strong></li> <li><span class=\"cd-time\">hours</span> <strong>%{h}</strong></li> <li><span class=\"cd-time\">mins</span> <strong>%{m}</strong></li> <li><span class=\"cd-time\">sec</span> <strong>%{s}</strong></li>",
				minus: false,
				onChange: null,
				onComplete: null,
				onResume: null,
